...
def main(working_dir: str, studentify_dir: str, archive_name: str, skip_cleaning: bool = False, skip_packaging: bool = False):
    ...
    files_to_studentify = ["src/renderer/core/light/AmbientLight.java",
                           ...
                           "src/renderer/core/shader/fragmentshaders/LightShader.java",
    ...
    files_to_remove = [
        "src/renderer/core/shader/fragmentshaders/DepthShader.java",
        "src/renderer/core/shader/fragmentshaders/NormalMapShader.java",
