...
public class OutputMerger {
    ...
    /**
     * Merge the information outputed by the rasterizer and the
     * fragment shader(s) to display on the final image.
     *
     * Is also responsible for handling the depth check of the fragment.
     *
     * @param fragment the fragment information given by the rasterizer
     * @param out the fragment shader's output information
     */
    public void merge(Fragment fragment, FragmentOutput out) {
        ...
        //++ // TODO : Test depth and write the fragment color to
        //++ // the screen only if it is visible
