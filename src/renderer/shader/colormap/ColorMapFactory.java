...
public class ColorMapFactory {
    ...
    public static ColorMap create(Maps name) {
        switch (name) {
            case VERIDIS: return new ColorMap(buildViridis());
            case MAGMA: return new ColorMap(buildMagma());
            default: throw new RuntimeException(name + " is unknown as a colormap.");
        }
    }
