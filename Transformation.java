...
public class Transformation  {
    ...
    public Transformation () {
        try {
            worldToCamera = new Matrix ("W2C", 3, 4);
    ...
    public void setProjection (double focal, double width, double height) {
        projection.set (0, 0, focal);
        projection.set (1, 1, focal);
        projection.set (0, 2, width/2.0);
        projection.set (1, 2, height/2.0);
    ...
    public Vector3 projectPoint (Vector p)
        ...
        Vector ps = projection.multiply (pe);
